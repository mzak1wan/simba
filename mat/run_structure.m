function [m_times, m_train, m_val, m_test] = run_structure(m_A, m_B, m_C, m_D, m_mask_A, m_mask_B, m_mask_C, m_mask_D, m_U, m_Y, m_U_val, m_Y_val, m_U_test, m_Y_test, Ts, m_enforce_stability)
...
[sys, m_x0] = n4sid(data, nx, opt, 'Ts', Ts);
init_sys = idss(sys);
...
sys = ssest(data, init_sys, opt, 'Ts', Ts);
m_times = [m_times, toc];
ssmodel=idss(sys);
